...
<div class="panel">
    ...
    <div class="media-block">
      <a class="media-left" href="#"><img class="img-circle img-sm" alt="Profile Picture" src="https://bootdey.com/img/Content/avatar/avatar1.png" width="50" height="50"></a>
      <div class="media-body">
        ...
        <div>
          <div class="media-block">
            <a class="media-left" href="#"><img class="img-circle img-sm" alt="Profile Picture" src="https://bootdey.com/img/Content/avatar/avatar2.png" width="50" height="50"></a>
            <div class="media-body">
              <div class="mar-btm">
          ...
          <div class="media-block">
            <a class="media-left" href="#"><img class="img-circle img-sm" alt="Profile Picture" src="https://bootdey.com/img/Content/avatar/avatar3.png" width="50" height="50">
            </a>
            <div class="media-body">
              <div class="mar-btm">
    ...
    <div class="media-block pad-all">
      ...
      <div class="media-body">
        ...
        <img class="img-responsive thumbnail" src="https://via.placeholder.com/400x300" alt="Image" width="10" height="10">
        <div class="pad-ver">
